    ...
    render() {
        return (
            <div className="row">
                ...
                <p className="text-muted">You can enhance the marketplace with social media plugins, newsletter forms, activity tracking and many more by integrating with SumoMe. Try it for free here: <a href="https://go.sumo.com/8212.htm" target="_blank"></a></p>
