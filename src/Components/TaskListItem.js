    ...
    constructor(props) {
        ...
        this.state = {
            ...
            bookedRequest: props
                .task
                .requests
                .find(_ => _.status === REQUEST_STATUS.BOOKED)
        };
    }
        ...
        return (
            <div
                ...
                {this.state.ready && <Paper style={{
                    ...
                    <div className="row">
                        {(this.state.properties.editButton || this.state.properties.cancelButton || this.state.properties.requestsButton || this.state.properties.bookingDetails || this.state.properties.markAsDoneButton || this.state.properties.leaveReviewButton) && <div className="col-xs-12">
                            <div className="row">
                                <div className="col-xs-12 col-sm-6">
                                    ...
                                    {this.state.properties.cancelButton && this.state.task && <div
                                        style={{
                                        display: 'inline-block',
                                        marginTop: 10,
                                        marginRight: 5
                                ...
                                <div className="col-xs-12 col-sm-6 text-right">
                                    ...
                                    {this.state.task.status === TASK_STATUS.ACTIVE && <div
                                        style={{
                                        display: 'inline-block',
                                        padding: 2
                                    }}>
