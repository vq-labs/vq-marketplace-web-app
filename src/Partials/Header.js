...
class Header extends Component {
  ...
  componentWillReceiveProps (nextProps) {
    ...
    if (nextProps.user) {
      ...
      this.setState({ logged: false, userId: undefined, user: undefined });
    }
      ...
      return (
        <div >
          <Toolbar className="st-nav">
            <a href="/" target="_self">
              <img className='imgCenter' src={this.props.logo} role="presentation" style={{ 'marginTop': '6px','marginBottom': '8px'}}/>
            </a>  
                  <ToolbarGroup>
